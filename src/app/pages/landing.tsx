  ...
  return (
    <div className="relative min-h-screen">
      <img
        ...
        alt="paws"
      />
      <div className="!2xl:text-lg relative flex h-min w-full flex-none flex-col flex-nowrap items-center justify-start gap-0 overflow-visible bg-primary p-3 !text-base md:p-6">
        <Header />
